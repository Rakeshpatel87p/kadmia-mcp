...
export const KADMIA_API_BASE = process.env.KADMIA_API_BASE || "https://kadmia-postgresql-staging.up.railway.app/api";
...
export const LEARNER_ID = parseLearnerIdFromArgs() || process.env.KADMIA_LEARNER_ID;
export const ADMIN_SECRET = process.env.KADMIA_ADMIN_SECRET;
